...
namespace :deploy do
  ...
  task :symlink_config, roles: :app do
    run "ln -nfs #{shared_path}/config/database.yml.production-sample #{release_path}/config/database.yml"
    run "ln -nfs #{shared_path}/config/redis.yml.sample #{release_path}/config/redis.yml"
  end 
